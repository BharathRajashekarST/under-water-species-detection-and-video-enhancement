...
# Route to handle the request triggered by the "Detect" button
...
def generate_progress():
    ...
    while success:
        ...
        if success:
            ...
            results = model(gen_hr)  # Assuming UltraYtics returns detections directly
            ...
            # Simulating progress (not accurate)
...
def get_content():
    ...
    content = wiki(element_id).parashort2 # Assuming parashort2 contains the content you want to display
    return content
